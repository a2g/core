...
public class SayAction extends BaseAction {
    ...
    public SayAction(BaseAction parent, int objId, String fullSpeech) {
    ...
    public void runGameAction() {
        ...
        if (object != null) 
        {
            ...
            int durationOfSingleAnimation = anim.getFrames().count() * (40 * object.getTalkingAnimationDelay());
            
            double numberOfTimesAnimRepeats = totalDuration/durationOfSingleAnimation;
            numberOfFramesTotal = (int)(numberOfTimesAnimRepeats * anim.getFrames().count());
