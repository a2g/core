...
IScenePresenterFromBoundaryCalculator {
    ...
    public ScenePresenter(final IHostingPanel panel,
        ...
        this.entrySegment = -1;
        defaultSceneObjectOtid = UNINITIALIZED;
    ...
    public void repositionDefaultObjectIfNeeded() 
    {
        ...
        SceneObject o = scene.objectCollection().getByOtid(defaultSceneObjectOtid);
    ...
    public void clearDefaultObject() {
        this.defaultSceneObjectOtid = UNINITIALIZED;
    }
