...
implements ImagePanelAPI, InventoryPanelAPI
{
	InternalAPI api;
    ...
    */
	...
	final com.google.gwt.user.client.ui.Image getImageFromResource(PackagedImage imageResource, LoadHandler lh)
	{
			...
			//else
			{
				final com.google.gwt.user.client.ui.Image image = imageResource.unpack();
	...
	public Image createNewImageAndAdddHandlers(PackagedImage imageResource,
			...
			int objectCode, int i, int j) 
	{
		...
		(
				new InventoryItemMouseOverHandler(bus, api, objectTextualId, objectCode)
		);		
