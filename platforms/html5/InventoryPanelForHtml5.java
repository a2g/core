...
IPlatformScenePanel {
	...
	public InventoryPanelForHtml5(EventBus bus, IInventoryPresenterFromInventoryPanel toInventory,
		...
		//canvasEtcHtml5.addMouseMoveHandler(new SceneMouseOverHandler(this, bus, toInventory, toCommandLine));
