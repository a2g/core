...
public interface IMasterPresenterFromBundle
{
	 ...
	 */
	public boolean addImageForAnInventoryItem(LoadHandler lh, String textualIdForInventory, int codeForInventory, IPackagedImage imageResource);
	...
	@return true on success, otherwise false.
	 */
	public boolean addImageForASceneObject(LoadHandler lh, int numberPrefix, int x, int y, int w, int h, String textualIdForObject, String animCode, short codeForObject, String objectPlusAnimCode, IPackagedImage imageResource);
